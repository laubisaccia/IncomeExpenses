  ...
  return (
    <>
      {profile?.accounts?.length <= 0 ? (
        <h2 className="text-center text-3lg mt-5">No Account Summary Found</h2>
      ) : (
        <section className="py-20">
          <h1 className="text-3xl text-center mb-5 text-indigo">
            Account Summary - for{" "}
            {profile?.accounts && profile?.accounts?.length} Accounts
          </h1>
